...
def start_timer():
    ...
    if reps % 8 == 0:
        pomo_label.config(text="Long Break", fg=RED)
        countdown(long_break_sec)
    elif reps % 2 == 0:
        pomo_label.config(text="Short Break", fg=PINK)
        countdown(short_break_sec)
    else:
        pomo_label.config(text="Work Time", fg=GREEN)
        countdown(work_sec)
...
pomo_label = Label(text="Timer", font=(FONT_NAME, 35, "bold"), fg=GREEN, bg=YELLOW)
